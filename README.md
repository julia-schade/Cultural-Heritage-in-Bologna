...
To enhance accessibility and promote the preservation of cultural properties, the project aims to select artifacts and represent them using the Resource Description Framework (RDF) based on the ARCO (Architecture of Cultural Heritage Ontology) and to produce new relevant knowledge in the form of RDF triples that could be added to the knowledge graph.
